...
////				hs = hs + " ";
////		}
//		hs = "fc 35 1c 71 10 00 00 00 7f b7 41 81 8f 1f 54 37 d9 78 86 c8 5e a4 d0 42";
//		return hs.toUpperCase();
//	}

	public static void main(String[] args) {
		String key = "MICROTEAM";
		String password = "123456789123456789123456789";
		System.out.println("key=" + key + ",password=" + password);
		try {
			String encrypt = EncryptUtils.Encrypt3DES(password, ConstData.KEY);
//			String encrypt = EncryptUtils.Encrypt3DES(password, key);
//			String decrypt = "";
...
//			System.out.println("用预转换密钥算加密结果=" + encrypt);
			System.out.println("加密结果=" + encrypt + "\t" + encrypt.length());
			System.out.println("加密结果=" + EncryptUtils.Encrypt3DES(password, key));
			try {
//				decrypt = new String(EncryptUtils.decryptMode(bkey, Base64.decode(encrypt)));
//				System.out.println("用预转换密钥算解密结果=" + decrypt);
				System.out.println("解密结果=" + EncryptUtils.Decrypt3DES(encrypt, key));
			} catch (Exception ex) {
